...
export function SimplePalette(props: { hexes: string[] }) {
    ...
    function SimpleSwatchBox(props: { hex: string })  {
        return (
            ...
            <p style={{textAlign:"center", fontStyle:"italic", alignSelf:"center", color:"white", letterSpacing:"2px", fontFamily:"monospace", fontWeight:"bolder", textShadow:"-1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000"}}>{props.hex}</p>
            </div>
        )
    }
